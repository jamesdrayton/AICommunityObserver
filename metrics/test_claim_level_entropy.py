...
def generate_questions(claim):
    prompt = f"""
        ...
        "{claim}"
        Generate 3 fact-checking questions that directly test the truth of this claim. 
        Each question should include the entities or events from the sentence (e.g., place names, people, dates) and aim to elicit a factual, concise answer. 
